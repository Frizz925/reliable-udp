...
func (sd StreamData) String() string {
	return fmt.Sprintf(
		"StreamData(StreamFrame: %+v, Offset: %d, Length: %d)",
...
func (sda StreamDataAck) String() string {
	return fmt.Sprintf("StreamDataAck(StreamFrame: %+v, Offset: %d)", sda.StreamFrame, sda.Offset)
}
...
func (sdf StreamDataFin) String() string {
	return fmt.Sprintf("StreamDataFin(StreamFrame: %+v, Length: %d)", sdf.StreamFrame, sdf.Length)
}
